	...
	@endforeach  <button class="btn-sm btn-info" onclick="actualizar_huevo()">MODIFICAR</button>	</div></td>
				...
				@foreach($tipo_caja as $can)
				  <td style="background-color: {{ $can->color }}">
					<font style=" background-color: white;">Cajas en Deposito:</font>
			...
			<h1>HUEVOS DESCARTES</h1>
				...
				@endforeach	
				  <td style="background-color: white">HUEVOS DEPOSITO <br><font size="6" id="total2"><?php echo $total2; ?></font><br>
				  HUEVOS HOY <br><font size="6" id="total_maple_dia"><?php echo $total_maple_dia; ?></font></td>		
				</tr> 
			</table>
			</div>
		</div>
